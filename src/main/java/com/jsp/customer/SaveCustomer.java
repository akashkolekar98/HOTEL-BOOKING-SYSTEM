	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (!(name.isBlank() || username.isBlank() || password.isBlank() || AadharNo.isBlank()
			...
			if (customerService.validate(customer) && customerService.validatName(customer)) {
				...
				printWriter
						.write("<a href='http://localhost:8080/Hotel-Booking-System/Customerlogin.html'>Go To Login Page</a>");
			} else {
				PrintWriter printWriter = resp.getWriter();
			...
			printWriter.write("<a href='http://localhost:8080/Hotel-Booking-System/first.html'>Go To Login Page</a>");
		}
